          ...
          <div class="headBox">
            ...
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
              ...
              <el-submenu index="/Aboutme">
                <template slot="title"><i class="fa fa-wa fa-flask"></i> 实战</template>
                <el-menu-item v-for="(item,index) in projectList" :key="'class2'+index" index=""><a :href="item.nav_url"
                                                                                                    target="_blank">{{item.nav_name}}</a>
                </el-menu-item>
              </el-submenu>
              <el-menu-item index="/friendslink"><i class="fa fa-wa fa-users"></i> 时间轴</el-menu-item>
              <el-menu-item index="/message"><i class="fa fa-wa fa-pencil"></i> 留言板</el-menu-item>
              <el-menu-item index="/aboutme"><i class="fa fa-wa fa-vcard"></i> 博主</el-menu-item>
...
<!--          </div>-->
    ...
    <div class="headImgBox"
         :style="{backgroundImage:'url(static/img/header/headerback_1200.jpg)'}">
      <div class="scene">
        <div><span id="luke"></span></div>
      </div>
      <div class="h-information">
        <a href="#/aboutme">
          <img src="static/img/header/mingren.jpeg" alt="" title="点击查看博主介绍">
        </a>
        <h2 class="h-description">
          <a href="#/aboutme">
            For Freedom.For Independence.For Duty
          </a>
        </h2>
      </div>
    </div>
...
<style>
  ...
  .blogName{
    ...
    text-align: center;
    color: #FF7F00;
    animation: bn 2s ease-in;
    -webkit-animation: bn 2s ease-in;
  }
