...
<template>
    <div class="footBack">
      <div>
        <img src="static/img/icon/WechatIMG37.jpeg" class="leftIconWX" alt=""/>
        <img src="static/img/icon/WechatIMG38.jpeg" class="leftIconZFB" alt=""/>
      </div>
      <div class="fcontainer">
          ...
          <p>
            部署于 <a href="https://github.com/Aimee1608/myblogvue" target="_blank">GitHub</a>. <a href="https://cloud.tencent.com/" target="_blank">腾讯云</a> 提供文件云存储服务.容器化管理.
          </p>
          <p>
              <span>Made with</span> <img class="fheart" src="static/img/heart02.png"/>  <span>by Wangxm...</span>备案号:XXXXXXXXXXX.
          </p>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2020/04/30 00:00:00');
