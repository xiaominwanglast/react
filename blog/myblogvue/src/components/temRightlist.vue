...
<template>
    <div class="rightlistBox">
        <section >
            <div class="r1-head">
                <img src="static/img/header/kkx.jpeg" alt="">
    ...
    export default {
        data() { //选项 / 数据
            return {
                ...
                catchMeObj:{//抓住我 个人信息
                        git: 'https://github.com/xiaominwanglast',
                        qq: 'static/img/aimee/QQ.jpg',
                        sina: 'https://weibo.com/u/5470434918',
                        wechat: 'static/img/aimee/erwm.jpg',
                        csdn: 'https://blog.csdn.net/beyond_f',
                        job: ''
                },
            }
        },
